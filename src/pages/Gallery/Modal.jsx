...
export default function Modal({ setOpenModal, displayData }) {
  ...
  return (
    <>
      {videos.map((el) =>
        el.id === displayData.id ? (
          <div key={el.id} className="fixed inset-0 z-10">
            <div
            ...
            <div className="flex items-center w-full min-h-screen">
              <div className="relative mx-auto my-0 bg-black rounded-md shadow-lg">
                <div className="sm:flex">
                  <div className="text-center sm:py-10 sm:text-left bg-black rounded-md">
                    <iframe
                      className="sm:w-96 mt-20"
                      height="300"
                      src={el.url}
                      title="Arshad Ali and Nawwaal | Cape Town Wedding Film"
                      frameBorder="0"
